<div class="container main">
    ...
    <div class="card-info">
        <div class="card" style="width: 18rem;">
            <img src="./assets/img/vanchuyen.jpg"
                class="card-img-top" alt="card info">
            <div class="card-body">
        ...
        <div class="card" style="width: 18rem;">
            <img src="./assets/img/thongminh.jpg"
                class="card-img-top" alt="card info">
            <div class="card-body">
        ...
        <div class="card" style="width: 18rem;">
            <img src="./assets/img/congnghe.jpg"
                class="card-img-top" alt="card info">
            <div class="card-body">
    ...
    <div class="map">
        <iframe
            ...
            width="1000px" height="550" style="border: 0px; visibility: visible; animation-name: fadeIn;"
