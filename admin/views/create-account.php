...
if (isset($_POST['btnCreate'])) {
    ...
    $checkPostoffice = Postoffice::find([
        "maBuuCuc" => $postoffice,
    ]);
    ...
    if($password === $rePassword) {
        ...
        if ($checkEmloyeeId) {
            ...
            $employee = Employee::create([
                "maNhanVien" => $employeeId,
                "idBuuCuc" => $checkPostoffice->idBuuCuc,
                "chucVu" => $position,
                "tenNhanVien" => $name,
                "soDienThoai" => $phone,
            ...
            if (!$employee) {
                ...
                $error = "Mã bưu cục không tồn tại!";
            }
    ...
    if ($error === "") {
        echo '<script>
            ...
            window.location.href = "'.$this->geturl("postoffice-user").'";
            </script>';
    } else {
        echo '<script>alert("'. $error. '");
        window.location.href = "'.$this->geturl("create-account").'";
        </script>';
    }
}
?>
...
<section class="content">
    ...
    <form action="<?php echo $this->geturl("create-account"); ?>" method="POST">
        <div class="row">
            ...
            <div class="col-md-6 mt-8">
                ...
                <select name="position" id="position" class="form-control" required="required">
                    ...
                    <option value="owner">Chủ bưu cục</option>
            ...
            <div class="col-md-6 mt-8">
                ...
                <input type="text" id="postofficeId" class="form-control" placeholder="Nhập mã bưu cục" pattern=".{6}" maxlength="6" name="postofficeId"
                    required>
